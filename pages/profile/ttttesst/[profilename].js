...
export const getServerSideProps = async (context) => {
  ...
  let nameResponse = await fetch(
    "http://localhost:3000/api/individualnames/namesContainingUserId/" + nameid
  );
              ...
              <div className="px-6">
                ...
                <div className="text-center">
                  <div className=" w-full pb-4">
                    <a
                      href="#"
                      className=" mr-2 mx-auto bg-yellow-500 hover:bg-yellow-400 border-b-4 border-yellow-700 
      hover:border-yellow-500 text-center py-2 px-4 rounded"
                  ...
                  <div className="mb-2 font-bold">
                    <FontAwesomeIcon
                      ...
                      className="mr-2 text-lg "
                    />
                    <span className="mr-2 text-lg">Rank: {"mystery"}</span>
                  </div>
                </div>
        ...
        <div className=" flex-1 grid grid-cols-1 gap-4 mr-2 h-fit">
          {!nameList.length ? (
