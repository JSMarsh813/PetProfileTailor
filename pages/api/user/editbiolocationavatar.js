...
console.log(`this is profileUserId  ${profileUserId}`)
  ...
  console.log(`this is toUpdateUserBioLocationAvatar ${toUpdateUserBioLocationAvatar}`)
...
console.log(`this is user._id ${user._id}`)
  ...
  console.log(`this is toUpdateUserBioLocationAvatar2 ${toUpdateUserBioLocationAvatar}`)
