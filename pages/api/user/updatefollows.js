...
//result: this is user._id 63a90c2e83e6366b179ffc40
  ...
  toUpdateUserFollowers.followers.includes(user._id)? 
        ...
        (toUpdateUserFollowers.followers= toUpdateUserFollowers.followers.filter(userinfollowers=> 
            userinfollowers!=user._id)):

        (toUpdateUserFollowers.followers=toUpdateUserFollowers.followers.concat(user._id))
