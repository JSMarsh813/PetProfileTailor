...
//  console.log(`this is data ${JSON.stringify(data)}`)
  let descriptionResponse= await fetch('http://localhost:3000/api/description');  
...
function FetchDescriptions({sessionFromServer, category, descriptionList,tagList}) {
     ...
     //for Nav menu profile name and image
      ...
      const[IsOpen,SetIsOpen] = useState(true)
       ...
       const[filteredDescriptions,setFilteredDescriptions]=useState([...descriptionList])
  ...
  useEffect(()=>{
    ...
    setFilteredDescriptions( filteredDescriptions.filter((description)=>
