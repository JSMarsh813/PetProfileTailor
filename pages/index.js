...
function HomePage({sessionFromServer}) {
  ...
  return <div className="w-fit bg-violet-900">
   ...
   <section 
      className="w-full bg-violet-900 ~ h-24 flex place-items-center justify-center">
          ...
          <img 
            src={"https://static.wikia.nocookie.net/southpark/images/e/e7/Guinea-pigs-stripe.png"} 
            style={{height:"160px",
            paddingBottom:"27px",
            paddingLeft: "50px"}}/>
  ...
  <section 
      className="landingNamesSection bg-violet-900">

<WideCenteredHeading
      heading="Find the Purrfect Name"/>    
     ...
     <section className="landingDescriptionsSection bg-violet-900">
        ...
        <WideCenteredHeading
            heading="Find Tailor-fit Descriptions"/>
    ...
    <section 
        className="landingSignUpSection">

<WideCenteredHeading
            heading="Create a free profile to access extra features"/>
    ...
    <section 
        className="LandingWantToHelpSection">

<WideCenteredHeading
            heading="Psst...Want To Help Some Pets 😸🐹?"/>
