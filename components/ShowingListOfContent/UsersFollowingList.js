...
<h1
       ...
       {userData[0]?userData.map((person)=>
       <a href={`http://localhost:3000/profile/${person.name.toLowerCase()}`}>
    <section
    ...
    bg-darkPurple
        ...
        <section>
          <span 
                className="block">  {person.name} 
          </span>

          <span  
                className="block"> @{person.profilename}
        </span>     
    ...
    <p
      className="py-4">Currently not following anyone 😿</p>
