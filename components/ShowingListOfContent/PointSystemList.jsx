...
import { faBowlFood, faCookieBite,faRankingStar, faTags, faIgloo, faLightbulb, faIdCard, faComment,faHeart, faCirclePlus} from '@fortawesome/free-solid-svg-icons'
...
}) 
{
    const [treatBreakdownMenuOpen,settreatBreakdownMenuOpen]=useState(false)
          ...
          useEffect(()=>{
              ...
              useEffect(()=>{
                ...
                [namesLikedPoints,namesAddedPoints,
                  commentsLikedPoints,commentsAddedPoints,
                  postsLikedPoints,postsAddedPoints
                 ]
              )
  ...
  return (
    ...
    <section 
            className="userStatsSection pt-4">
      
    <section 
            className="overallStats mb-2 font-bold text-white text-center">
        <div>
             <FontAwesomeIcon 
                      icon={faCookieBite} 
    ...
    <GeneralOpenCloseButton 
     ...
     { treatBreakdownMenuOpen==true&&( 
        ...
        <section className="userStatsBreakdownDropDown 
         ...
         ">
           ...
           <span className="text-yellow-300"> Added content is worth *3 bonus points! </span>
