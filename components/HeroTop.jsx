...
return (
<div className="hero min-h-fit font-serif 
border-y-4 border-darkPurple  "
 style={{ backgroundImage: `url("https://img.buzzfeed.com/buzzfeed-static/static/2018-08/20/12/asset/buzzfeed-prod-web-03/anigif_sub-buzz-25459-1534782361-2.gif")`,
  ...
  <div className="hero-content text-center text-neutral-content mb-10">
    <div className="max-w-xl text-white">
      <h1 className="mb-5 text-5xl text-yellow-300 font-black"> Welcome to <br/> Pet Profile Tailor!</h1>
           <p className="mb-5 text-xl"> Naming your new pet or creating engaging pet profiles for pets can feel ruff! We've been there! And we’re here to help.</p>
        ...
        <section className="w-full flex justify-center gap-3">
                    <div className="flex-1">
                           ...
                           <button className="btn btn-primary w-full mt-2 bg-yellow-300 text-violet-900 font-black text-lg h-16
                           
                           hover:text-yellow-300">Impactful</button>
                    </div>
                    ...
                    <div className="flex-1">
                            ...
                            <button className="btn btn-primary w-full mt-2 bg-yellow-300 text-violet-900 text-lg h-16
                    ...
                    <div className="flex-1">
                               ...
                               hover:text-yellow-300">Tailor Fitted</button>
                    </div>
        </section>
