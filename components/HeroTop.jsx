      ...
      <h1 className="mb-5 text-5xl text-yellow-300 font-black"> Welcome to <br/> Pet Profile Tailor!</h1>
        ...
        <section className="w-full flex justify-center gap-3">
                    <div className="flex-1">
                           ...
                           <button className="btn btn-primary w-full mt-2 bg-yellow-300 text-violet-900 font-black text-lg
                    ...
                    <div className="flex-1">
                            ...
                            <button className="btn btn-primary w-full mt-2 bg-yellow-300 text-violet-900 text-lg
