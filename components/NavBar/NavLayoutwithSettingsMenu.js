...
export default function NavLayoutwithSettingsMenu({ title, children, userName, profileImage}) {
  ...
  <Menu.Button className="inline-flex justify-center md:hidden"
   ...
   {/* Name disappears at smaller screen sizes */}
            ...
            <Link href="/">
              <a className="text-lg font-extrabold text-yellow-300 
              hidden lg:block ">PetProfileTailor</a>
            </Link>
            ...
            />
                  ...
                  <Menu.Items className="absolute right-0 w-56 origin-top-right bg-violet-800 text-white shadow-lg ">
                    ...
                    <Menu.Item className="group flex w-full items-center rounded-md px-2 py-2 text-md
